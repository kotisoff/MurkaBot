...
const BuyPickaxe = new Command("buypickaxe","",{slash:false, prefix:true});
...
BuyPickaxe.setPrefixAction(async(m,b)=>{
    ...
    if(profile.coins<10) return m.channel.send("К сожалению, в данный момент у вас не хватает монет для приобретения кирки.");
    profile.coins-=10;
    profile.picklvl=1;
